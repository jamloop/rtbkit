/* adaptvhv_exchange_connector.cc
...
#include "adaptvhv_exchange_connector.h"
...
Logging::Category adaptvhvExchangeConnector::Logs::print(
    "adaptvhvExchangeConnector");
Logging::Category adaptvhvExchangeConnector::Logs::trace(
    "adaptvhvExchangeConnector Trace", adaptvhvExchangeConnector::Logs::print);
Logging::Category adaptvhvExchangeConnector::Logs::error(
    "adaptvhvExchangeConnector Error", adaptvhvExchangeConnector::Logs::print);

    adaptvhvExchangeConnector::adaptvhvExchangeConnector(
    ...
    void
    adaptvhvExchangeConnector::initCreativeConfiguration()
    {
    ...
    adaptvhvExchangeConnector::getCampaignCompatibility(
    ...
    ExchangeConnector::ExchangeCompatibility
    adaptvhvExchangeConnector::getCreativeCompatibility(
    ...
    double
    adaptvhvExchangeConnector::getTimeAvailableMs(
    ...
    adaptvhvExchangeConnector::parseBidRequest(
            HttpAuctionHandler& handler,
            const HttpHeader& header,
            const std::string& payload)
    {
    ...
    void
    adaptvhvExchangeConnector::setSeatBid(
            ...
            OpenRTB::BidResponse& response) const
    {
        ...
        adaptvhvCreativeConfiguration::Context context {
            creative,
            resp,
            *auction.request,
            spotNum
...
struct Init {
    Init() {
        RTBKIT::ExchangeConnector::registerFactory<JamLoop::adaptvhvExchangeConnector>();
    }
} init;
